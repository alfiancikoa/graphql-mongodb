...
func (ec *executionContext) _Movie_stars(ctx context.Context, field graphql.CollectedField, obj *model.Movie) (ret graphql.Marshaler) {
	...
	fc.Result = res
	return ec.marshalNStar2ᚕᚖgithubᚗcomᚋalfiancikoaᚋgraphqlᚑmongodbᚋgraphᚋmodelᚐStarᚄ(ctx, field.Selections, res)
}
...
func (ec *executionContext) _Mutation_addMovie(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	fc.Result = res
	return ec.marshalNMovie2ᚖgithubᚗcomᚋalfiancikoaᚋgraphqlᚑmongodbᚋgraphᚋmodelᚐMovie(ctx, field.Selections, res)
}
...
func (ec *executionContext) _Mutation_deleteMovie(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	resTmp, err := ec.ResolverMiddleware(ctx, func(rctx context.Context) (interface{}, error) {
		ctx = rctx // use context from middleware stack in children
		return ec.resolvers.Mutation().DeleteMovie(rctx, args["id"].(int))
	})
	if err != nil {
		ec.Error(ctx, err)
		return graphql.Null
...
func (ec *executionContext) _Query_movies(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	res := resTmp.([]*model.Movie)
	fc.Result = res
	return ec.marshalNMovie2ᚕᚖgithubᚗcomᚋalfiancikoaᚋgraphqlᚑmongodbᚋgraphᚋmodelᚐMovieᚄ(ctx, field.Selections, res)
}
...
func (ec *executionContext) marshalNMovie2githubᚗcomᚋalfiancikoaᚋgraphqlᚑmongodbᚋgraphᚋmodelᚐMovie(ctx context.Context, sel ast.SelectionSet, v model.Movie) graphql.Marshaler {
	return ec._Movie(ctx, sel, &v)
}

func (ec *executionContext) marshalNMovie2ᚕᚖgithubᚗcomᚋalfiancikoaᚋgraphqlᚑmongodbᚋgraphᚋmodelᚐMovieᚄ(ctx context.Context, sel ast.SelectionSet, v []*model.Movie) graphql.Marshaler {
	...
	for i := range v {
		...
		f := func(i int) {
			...
			ret[i] = ec.marshalNMovie2ᚖgithubᚗcomᚋalfiancikoaᚋgraphqlᚑmongodbᚋgraphᚋmodelᚐMovie(ctx, sel, v[i])
		}
		if isLen1 {
			f(i)
		} else {
...
func (ec *executionContext) marshalNMovie2ᚖgithubᚗcomᚋalfiancikoaᚋgraphqlᚑmongodbᚋgraphᚋmodelᚐMovie(ctx context.Context, sel ast.SelectionSet, v *model.Movie) graphql.Marshaler {
	if v == nil {
		if !graphql.HasFieldError(ctx, graphql.GetFieldContext(ctx)) {
			ec.Errorf(ctx, "must not be null")
		}
...
func (ec *executionContext) marshalNStar2ᚕᚖgithubᚗcomᚋalfiancikoaᚋgraphqlᚑmongodbᚋgraphᚋmodelᚐStarᚄ(ctx context.Context, sel ast.SelectionSet, v []*model.Star) graphql.Marshaler {
	...
	for i := range v {
		...
		f := func(i int) {
			...
			ret[i] = ec.marshalNStar2ᚖgithubᚗcomᚋalfiancikoaᚋgraphqlᚑmongodbᚋgraphᚋmodelᚐStar(ctx, sel, v[i])
		}
		if isLen1 {
			f(i)
		} else {
...
func (ec *executionContext) marshalNStar2ᚖgithubᚗcomᚋalfiancikoaᚋgraphqlᚑmongodbᚋgraphᚋmodelᚐStar(ctx context.Context, sel ast.SelectionSet, v *model.Star) graphql.Marshaler {
	if v == nil {
		if !graphql.HasFieldError(ctx, graphql.GetFieldContext(ctx)) {
			ec.Errorf(ctx, "must not be null")
		}
